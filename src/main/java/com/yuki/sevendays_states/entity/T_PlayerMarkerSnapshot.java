...
@NoArgsConstructor
@Entity
@Table(name = "T_PLAYER_MARKER_SNAPSHOT")
public class T_PlayerMarkerSnapshot {
  ...
  @Column(name = "marker_type", nullable = false, length = 40)
  private String markerType;

  @Column(name = "ref_id", length = 80)
  private String refId;

  @Column(name = "position_data_type", length = 40)
